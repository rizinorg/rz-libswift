...
constexpr static const llvm::StringLiteral STDLIB_NAME = "Swift";
...
constexpr static const llvm::StringLiteral CLANG_HEADER_MODULE_NAME = "__ObjC";
/// The prefix of module names used by LLDB to capture Swift expressions
constexpr static const llvm::StringLiteral LLDB_EXPRESSIONS_MODULE_NAME_PREFIX =
    "__lldb_expr_";

/// The name of the fake module used to hold imported Objective-C things.
constexpr static const llvm::StringLiteral MANGLING_MODULE_OBJC = "__C";
/// The name of the fake module used to hold synthesized ClangImporter things.
constexpr static const llvm::StringLiteral MANGLING_MODULE_CLANG_IMPORTER =
    "__C_Synthesized";

/// The name prefix for C++ template instantiation imported as a Swift struct.
constexpr static const llvm::StringLiteral CXX_TEMPLATE_INST_PREFIX =
    "__CxxTemplateInst";

constexpr static const llvm::StringLiteral SEMANTICS_PROGRAMTERMINATION_POINT =
...
struct BuiltinNameStringLiteral {
  const llvm::StringLiteral literal;

  constexpr operator llvm::StringLiteral() const { return literal; }

  llvm::StringRef str() const {
    return llvm::StringRef(literal);
  }

  llvm::StringRef getWithoutPrefix() const {
    return llvm::StringRef(literal).drop_front(BUILTIN_TYPE_NAME_PREFIX.size());
  }
};
